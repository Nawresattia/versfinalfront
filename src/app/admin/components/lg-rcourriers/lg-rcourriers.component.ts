...
@Component({
  selector: 'app-lg-rcourriers',
  templateUrl: './lg-rcourriers.component.html',
  styleUrls: ['./lg-rcourriers.component.scss']
})
export class LgRCourriersComponent implements OnInit,AfterViewInit {
