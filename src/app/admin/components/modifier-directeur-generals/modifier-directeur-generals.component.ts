...
@Component({
  selector: 'app-modifier-directeur-generals',
  templateUrl: './modifier-directeur-generals.component.html',
  styleUrls: ['./modifier-directeur-generals.component.scss']
})
export class ModifierDirecteurGeneralsComponent implements OnInit {
  ...
  date: any="";
  password: any="";
  constructor(public dialogRef: MatDialogRef<ModifierDirecteurGeneralsComponent>,
