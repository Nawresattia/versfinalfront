...
@Component({
  selector: 'app-logbookgr',
  templateUrl: './logbookgr.component.html',
  styleUrls: ['./logbookgr.component.scss']
})
export class LogbookgrComponent implements OnInit, AfterViewInit {
