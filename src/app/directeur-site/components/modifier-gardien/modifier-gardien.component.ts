...
@Component({
  selector: 'app-modifier-gardien',
  templateUrl: './modifier-gardien.component.html',
  styleUrls: ['./modifier-gardien.component.scss']
})
export class ModifierGardienComponent implements OnInit {
    ...
    date: any="";
    password: any="";
    constructor(public dialogRef: MatDialogRef<ModifierGardienComponent>,
